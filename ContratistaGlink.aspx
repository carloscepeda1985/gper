<%@ Page Language="VB" MasterPageFile="~/MasterGlink.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ContratistaGlink.aspx.vb" Inherits="FichaContratista" Title="Glink" %>
    ...
    <script type="text/javascript">
        ...
        function successalert(rutTienda) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        location.href = "ContratistaGlink.aspx?rut=" + rutTienda;
                    }
                });
        }
  ...
  <div class="modal fade" data-backdrop="static" data-keyboard="false" id="myModaleli" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        ¿Esta seguro que desea eliminar éste contratista?
          </p>
          <br/>
        </div>
        <div class="modal-footer">

...
Partial Class frm_trabajadores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        conn.Open()
        sql = "SELECT rut, nombre, apellido,relacion, creacion, estado FROM personas_t where rut_p = '" & Session("rut_pro") & "' and deleted = '1' and tipo = 'Trabajador'"
        ...
        While (dr.Read())
            ...
            If dt.Columns.Count = 0 Then
                ...
                dt.Columns.Add("Función", GetType(String))
                ...
                Else
                    ...
                    Else
                        ...
                        Else
                            ...
                            conn = New OdbcConnection(conector)
                            conn.Open()
                            sql = "insert Into personas_t(id_condominio, rut_p,rut,nombre,apellido,tipo,relacion,estado,creacion,deleted,updates) Values('" & Session("idcond_pro") & "','" & Session("rut_pro") & "','" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox3.Text & "','Trabajador','" & TextBox4.Text & "','1','" & Now.ToString & "','1','0')"
                            comm = New OdbcCommand(sql, conn)
                            dr = comm.ExecuteReader()
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Response.Redirect("frm_editar_trabajador.aspx?dato=" + dato)

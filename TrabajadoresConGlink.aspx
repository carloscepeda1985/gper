<%@ Page Language="VB" MasterPageFile="~/MasterGlink.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="TrabajadoresConGlink.aspx.vb" Inherits="TrabajadoresCon" %>
    ...
    <script type="text/javascript">
        ...
        function successalert(rutTienda) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        location.href = "TrabajadoresConGlink.aspx"
                    }
                });
        }

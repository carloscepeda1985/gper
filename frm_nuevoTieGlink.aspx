    ...
    <div class="table-responsive">
        ...
        <center>
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label text-right">Contraseña*</label>
                    <div class="col-md-5 inputGroupContainer">
                        <div class="input-group">
                        ...
                        <div class="form-group" style="text-align: left">
                         <asp:RequiredFieldValidator id="reqContraseña" runat="server" CssClass="form-control" Font-Italic="True" ForeColor="Red" ControlToValidate="TextBox7" Display="Dynamic" ErrorMessage="Debe ingresar contraseña"/>
                        </div>
                    </div>
                </div>
                </br>

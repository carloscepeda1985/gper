...
Partial Class TrabajadoresCon
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Response.Redirect("EditarTrabajadorTieGlink.aspx?dato=" + dato)
    End Sub
    ...
    Protected Sub Button2_Click(sender As Object, e As System.EventArgs) Handles Button2.Click
        ...
        conn = New OdbcConnection(conector)
        conn.Open()
        sql = "SELECT rut,nombre,apellido,telefono,funcion,direccion,CDT,CAFP,AFC,INP,CCAF FROM trabajadores_tienda_m where estado = '1' and id_contratista='" & Session("id_contratista") & "' and nombre Like '%" & TextBox5.Text & "%'"
        comm = New OdbcCommand(sql, conn)
        dr = comm.ExecuteReader()
        I = 0
        Dim CDT, CAFP, AFC, INP, CCAF As String

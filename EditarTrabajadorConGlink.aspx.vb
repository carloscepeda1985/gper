...
Partial Class EditarTrabajadorContratista
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If (IsPostBack = False) Then
            ...
            conn.Open()
            sql = "SELECT rut,nombre,apellido,telefono,direccion,funcion,empresa FROM trabajadores_contratista_m where rut = '" & Request.QueryString("dato") & "' and deleted = '1'  and id_contratista='" & Session("id_contratista") & "'"
    ...
    Private Sub Submit6_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Submit6.ServerClick
        ...
        If Not File6.PostedFile Is Nothing And File6.PostedFile.ContentLength > 0 Then
            ...
            Try
                ...
                ' Response.Redirect("EditarTrabajadorConGlink.aspx?dato=" + Request.QueryString("dato"))

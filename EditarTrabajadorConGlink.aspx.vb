...
Partial Class EditarTrabajadorContratista
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If (IsPostBack = False) Then
            ...
            conn.Open()
            sql = "SELECT rut,nombre,apellido,telefono,funcion,empresa FROM trabajadores_contratista_m where rut = '" & Request.QueryString("dato") & "' and deleted = '1'  and id_contratista='" & Session("id_contratista") & "'"

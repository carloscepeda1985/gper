...
Partial Class CrearSolicitudGper
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.IsPostBack Then
            ...
            conn = New OdbcConnection(conector)
            conn.Open()
            sql = "insert Into aprobaciones_m(id_mall,id_contratista,id_solicitud,usuario,comentario,fecha,estado) Values('" & Session("id_mall") & "','" & Session("id_contratista") & "','" & Label9.Text & "','tienda','Envío de Solicitud','" & Now() & "','1')"
            comm = New OdbcCommand(sql, conn)
            dr = comm.ExecuteReader()

<%@ Page Language="VB" MasterPageFile="~/MasterSolicitudGlink.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="CrearSolicitudTieGlink.aspx.vb" Inherits="CrearSolicitudGper" Title="Glink" %>
    ...
    <script type="text/javascript">
        ...
        function successalert() {
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        location.href = "SolicitudesTieGlink.aspx";
                    }
                });
        }

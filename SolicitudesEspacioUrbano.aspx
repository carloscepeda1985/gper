<%@ Page Language="VB" MasterPageFile="~/MasterEspacioUrbano.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="SolicitudesEspacioUrbano.aspx.vb" Inherits="SolicitudesGper" %>
...
<ItemStyle Wrap="False" Width="150px"></ItemStyle>
    ...
    <div class="col-md-3">
     ...
     <ul class="nav nav-pills nav-stacked" background="#E9801E">
                   ...
                   <li><a href="ContratistasEspacioUrbano.aspx" class="btn btn-info btn-lg btn-block" style="line-height: 2;"><span class="glyphicon glyphicon-hand-right" style="color:white"></span>
                       <span class="nuevoEstilo3">&nbsp;Contratistas</span></a></li>
                   <li><a href="ReportesEspacioUrbano.aspx" class="btn btn-info btn-lg btn-block" style="line-height: 2;"><span class="glyphicon glyphicon-dashboard" style="color:white"></span>

<%@ Page Language="VB" MasterPageFile="~/MasterGlink.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditarTrabajadorConGlink.aspx.vb" Inherits="EditarTrabajadorContratista" Title="Glink" %>
    ...
    <script type="text/javascript">
        ...
        function successalert2(rutaTrabajador, mensaje) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        location.href = "EditarTrabajadorConGlink.aspx?dato=" + rutaTrabajador;
                    }
                });
        }

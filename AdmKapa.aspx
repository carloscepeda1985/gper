<%@ Page Language="VB" MasterPageFile="~/MasterKapa.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AdmKapa.aspx.vb" Inherits="AdmKapa" Title="YouSoft" %>
   ...
   <div class="col-md-9">
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" 
            ...
            <Columns>
                <asp:CommandField ButtonType="Button" ShowSelectButton="True" 
                    SelectImageUrl="~/editar.png" ControlStyle-CssClass="btn btn-info" SelectText="Ir" />
            </Columns>
    ...
    <div class="col-md-3">
     ...
     <ul class="nav nav-pills nav-stacked" background="#E9801E">
                   ...
                   <li><a href="CursosKapa.aspx" class="btn btn-info btn-lg btn-block"><span class="glyphicon glyphicon-book" style="color:white"></span>

<%@ Page Language="VB" MasterPageFile="~/MasterGper.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EquipoTransporte.aspx.vb" Inherits="EquiposGper" Title="Glink"  %>
...
.btn-sample .badge {
 color: #FFFFFF;
  ...
  border-color: #f4841a;
    ...
    <e class="letracolor"><span class="glyphicon glyphicon-road" style="color:white"></span>&nbsp;Equipo Transporte</e>

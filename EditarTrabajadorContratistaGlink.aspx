<%@ Page Language="VB" MasterPageFile="~/MasterGlink.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditarTrabajadorContratistaGlink.aspx.vb" Inherits="EditarTrabajadorContratista" Title="Glink" %>
    ...
    <script type="text/javascript">
        ...
        function successalert2(rutaTrabajador, mensaje) {
            ...
            swal({
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        location.href = "EditarTrabajadorContratistaGlink.aspx?dato=" + rutaTrabajador;
                    }
                });
        }

...
Partial Class FichaContratista
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Response.Redirect("EditarTrabajadorTiendaGlink.aspx?dato=" + dato + "&rut=" + Request.QueryString("rut"))
    End Sub
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        conn = New OdbcConnection(conector)
        conn.Open()
        sql = "Update tiendas_m SET estado=0 where id_mall='" & Session("idcond_pro") & "' and rut='" & Request.QueryString("rut") & "'"
        comm = New OdbcCommand(sql, conn)
        dr = comm.ExecuteReader()

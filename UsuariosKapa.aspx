<%@ Page Language="VB" MasterPageFile="~/MasterKapa.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="UsuariosKapa.aspx.vb" Inherits="UsuariosKapa" Title="YouSoft" %>
...
<br />
    ...
    <div class="col-md-3">
     ...
     <ul class="nav nav-pills nav-stacked" background="#E9801E">
                   ...
                   <li><a href="" class="btn btn-success btn-lg btn-block"><span class="glyphicon glyphicon-list-alt" style="color:white"></span>&nbsp;<span 
                           class="nuevoEstilo8">Solicitudes</span></a></li>

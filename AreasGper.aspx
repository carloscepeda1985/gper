<%@ Page Language="VB" MasterPageFile="~/MasterGper.Master" AutoEventWireup="false" CodeFile="AreasGper.aspx.vb" Inherits="AreasGper"  Title="Glink" %>
...
.btn-sample .badge {
 color: #FFFFFF;
  ...
  border-color: #f4841a;
    ...
    <e class="letracolor"><span class="glyphicon2 glyphicon-link" style="color:white"></span>&nbsp;Areas</e>
    ...
    <div class="col-md-3">
     ...
     <ul class="nav nav-pills nav-stacked" background="#E9801E">
                ...
                <li><a href="AdmGper.aspx" class="btn btn-info btn-lg btn-block" style="line-height: 2;"><span class="glyphicon glyphicon-home" style="color:white"></span>
                   ...
                   <li><a href="AreasGper.aspx" class="btn btn-danger btn-lg btn-block" style="line-height: 2;"><span class="glyphicon glyphicon-link" style="color:white"></span>
                       <span class="nuevoEstilo3">&nbsp;Areas</span></a></li>

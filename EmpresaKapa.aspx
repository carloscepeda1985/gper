<%@ Page Language="VB"  MasterPageFile="~/MasterKapa.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EmpresaKapa.aspx.vb" Inherits="EmpresaKapa" Title="YouSoft" %>
 ...
 color: #FFFFFF;
  ...
  border-color: #3BBFA5;
   ...
   <div class="col-md-9">
    ...
    <div container>
     <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal" style="float:right;">+ Nueva Solicitud</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Ingrese datos de la Solicitud</h4>
        </div>
        <div class="modal-body">
          ...
          Curso:<asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control"></asp:DropDownList> 

...
<div class="tab-content no-border padding-24">
				<div id="home" class="tab-pane in active">
					<div class="row">
						<div class="col-xs-12 col-sm-9">
							<h4 class="blue">
								<span class="middle">
                                    <asp:Label ID="Label10" runat="server" Text="Informe de Checklist"></asp:Label></span>
							...
							<div class="profile-user-info">
								...
								<div class="profile-info-row">
									<div class="profile-info-name"> Rut Usuario </div>
								...
								<div class="profile-info-row">
									<div class="profile-info-name"> Foto Final </div>
    ...
    <div class="table-responsive">
        <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="false" 
            ...
            <Columns>
            <asp:CommandField ButtonType="Button" ShowSelectButton="True" HeaderText='<span class="glyphicon glyphicon-edit" style="color:white"></span>' ControlStyle-CssClass="btn btn-info" SelectText="Foto" />
            ...
            <asp:BoundField DataField="Comentario" HeaderText="Comentario" ItemStyle-Width="130" ItemStyle-Wrap="false" />            

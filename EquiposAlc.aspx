<%@ Page Language="VB" MasterPageFile="~/MasterAlc.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EquiposAlc.aspx.vb" Inherits="EquiposAlc" Title="YouSoft" %>
 ...
 color: #FFFFFF;
  ...
  border-color: #f4841a;
   ...
   <div class="col-md-9">
    ...
    <div container>
     <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal" style="float:right;">Agregar Equipo</button>

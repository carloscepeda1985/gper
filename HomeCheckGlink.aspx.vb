...
Partial Class HomeCheck
    ...
    Protected Sub Button1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        If Request.QueryString("desde") = "ficha" Then
            Response.Redirect("FichaEquipoGlink.aspx?id=" & Request.QueryString("id_equipo") & "&tipo=" & Request.QueryString("tipo") & "&ubicacion=" & Request.QueryString("ubicacion") & "&instalacion=" & Request.QueryString("instalacion"))
        Else
            Response.Redirect("ReportesGlink.aspx")
        End If

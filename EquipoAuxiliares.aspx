<%@ Page Language="VB" MasterPageFile="~/MasterGper.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EquipoAuxiliares.aspx.vb" Inherits="EquiposGper" Title="Glink"  %>
...
.btn-sample .badge {
 color: #FFFFFF;
  ...
  border-color: #f4841a;
    ...
    <e class="letracolor"><span class="glyphicon glyphicon-object-align-horizontal" style="color:white"></span>&nbsp;Equipo Auxiliares</e>

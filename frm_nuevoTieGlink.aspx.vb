...
Partial Class frm_nuevo
    ...
    Protected Sub Button1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        conn = New OdbcConnection(conector)
        conn.Open()
        sql = "UPDATE tiendas_m set rut = '" & TextBox1.Text & "', nombre = '" & TextBox2.Text & "', contacto = '" & TextBox3.Text & "', telefono = '" & TextBox4.Text & "', email = '" & TextBox5.Text & "', pass = '" & TextBox7.Text & "' where rut = '" & Session("rut_contratista") & "'"
        comm = New OdbcCommand(sql, conn)
        dr = comm.ExecuteReader()

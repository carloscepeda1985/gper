<%@ Page Language="VB" MasterPageFile="~/MasterGper.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="TrabajadoresGper.aspx.vb" Inherits="TrabajadoresGper" Title="Glink" %>
...
.btn-sample .badge {
 color: #FFFFFF;
  ...
  border-color: #f4841a;
    ...
    <e class="letracolor"><span class="glyphicon2 glyphicon-briefcase" style="color:white"></span>&nbsp;Trabajadores</e>

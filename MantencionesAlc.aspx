<%@ Page Language="VB"  MasterPageFile="~/MasterGper.Master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="MantencionesAlc.aspx.vb" Inherits="MantencionesAlc" Title="YouSoft" %>
...
.btn-sample .badge {
 color: #FFFFFF;
  ...
  border-color: #f4841a;
   ...
   <div class="col-md-9">
    <div class="bar"><e class="letracolor"><span class="glyphicon2 glyphicon-wrench" style="color:white"></span>&nbsp;Mantenciones</e></div>
    <div container>

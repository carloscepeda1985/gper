...
Partial Class EditarTrabajadorContratista
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If (IsPostBack = False) Then
            ...
            conn = New OdbcConnection(conector)
            conn.Open()
            sql = "SELECT rut,nombre,apellido,telefono,direccion,funcion,empresa FROM trabajadores_tienda_m where rut = '" & Request.QueryString("dato") & "' and deleted = '1' and id_contratista='" & id_tienda & "'"
            comm = New OdbcCommand(sql, conn)
            dr = comm.ExecuteReader()
            I = 0
            If (dr.Read()) Then
    ...
    Private Sub Submit6_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Submit6.ServerClick
        ...
        If Not File6.PostedFile Is Nothing And File6.PostedFile.ContentLength > 0 Then
            ...
            Try
                ...
                'Response.Redirect("EditarTrabajadorTiendaGlink.aspx?dato=" + Request.QueryString("dato") + "&rut=" + Request.QueryString("rut")) 
    ...
    Protected Sub Button2_Click(sender As Object, e As System.EventArgs) Handles Button2.Click
        ...
        Response.Redirect("TiendaGlink.aspx?rut=" & Request.QueryString("rut"))

...
Partial Class EditarTrabajadorContratista
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If (IsPostBack = False) Then
            ...
            conn.Open()
            sql = "SELECT id FROM contratistas_m where rut = '" & Request.QueryString("rut") & "'"
            comm = New OdbcCommand(sql, conn)
            dr = comm.ExecuteReader()
            I = 0
            If (dr.Read()) Then

                id_contratista = dr.GetValue(0).ToString()
            ...
            conn = New OdbcConnection(conector)
            conn.Open()
            sql = "SELECT rut,nombre,apellido,telefono,direccion,funcion,empresa FROM trabajadores_contratista_m where rut = '" & Request.QueryString("dato") & "' and deleted = '1' and id_contratista='" & id_contratista & "'"
            comm = New OdbcCommand(sql, conn)
            dr = comm.ExecuteReader()
            I = 0
            If (dr.Read()) Then
    ...
    Protected Sub Button1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        conn = New OdbcConnection(conector)
        conn.Open()
        sql = "Update trabajadores_contratista_m Set nombre='" & TextBox1.Text() & "', apellido='" & TextBox2.Text() & "',telefono='" & TextBox3.Text() & "',direccion='" & TextBox6.Text() & "', funcion='" & TextBox4.Text() & "', empresa='" & TextBox5.Text() & "' Where rut='" & Request.QueryString("dato") & "'"
        comm = New OdbcCommand(sql, conn)
        dr = comm.ExecuteReader()

...
Partial Class EditarTrabajadorContratista
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If (IsPostBack = False) Then
            ...
            conn = New OdbcConnection(conector)
            conn.Open()
            sql = "SELECT rut,nombre,apellido,telefono,funcion,empresa FROM trabajadores_contratista_m where rut = '" & Request.QueryString("dato") & "' and deleted = '1' and id_contratista='" & id_contratista & "'"
            comm = New OdbcCommand(sql, conn)
            dr = comm.ExecuteReader()
            I = 0
            If (dr.Read()) Then

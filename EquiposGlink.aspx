...
<style>
    ...
    <div container>
    <div>
     <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="float:right;">+ Agregar</button>
        ...
        <asp:GridView ID="GridView1" runat="server" Width="100%" 
            ...
            <Columns>
                <asp:CommandField ButtonType="Button" ShowSelectButton="True" 
                    SelectImageUrl="~/editar.png" ControlStyle-CssClass="btn btn-primary" SelectText="Ficha" HeaderText='<span class="glyphicon glyphicon-list-alt" style="color:white"></span>' />
            </Columns>
